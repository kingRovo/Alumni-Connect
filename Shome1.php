...
<ul>
<li><a href ="gallery/comp.php">Placed</a></li>
...
<li ></li>
  ...
  <div id="common">
	...
	<div id="name">Name : <?php echo $total['name'];  echo "(".$total['st_id'].")";  ?> </div>
	<div id="university">University : <?php echo $total['un_name'];  ?></div>
	<div id="branch">Branch : <?php echo $total['branch'];  ?></div>
	<div id="year">Join-College : <?php echo $total['joining'];  ?></div>
	</div>
    



    <div class="event" ><marquee><i> 1.The Data science Workshop on 12/04/2019 in gla university  block(X) Room no. 331.
